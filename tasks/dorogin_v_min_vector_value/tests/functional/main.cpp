...
class NesterovARunFuncTestsProcesses : public ppc::util::BaseRunFuncTests<InType, OutType, TestType> {
 ...
 protected:
  void SetUp() override {
    ...
    {
      std::string abs_path = ppc::util::GetAbsoluteTaskPath(PPC_ID_dorogin_v_min_vector_value, "pic.jpg");
...
const auto kTestTasksList =
    std::tuple_cat(ppc::util::AddFuncTask<DoroginVMinVectorValueMPI, InType>(kTestParam, PPC_SETTINGS_dorogin_v_min_vector_value),
                   ppc::util::AddFuncTask<DoroginVMinVectorValueSEQ, InType>(kTestParam, PPC_SETTINGS_dorogin_v_min_vector_value));
